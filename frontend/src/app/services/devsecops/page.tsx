...
import { devsecopsContent } from "@/content/services/devsecops"

export const metadata: Metadata = {
  title: "DevSecOps",
  description: "Enterprise DevSecOps services including automated security pipelines and compliance as code.",
}

export default function DevSecOpsPage() {
  const { hero, overview, capabilities, benefits, approach, technologies, cta } = devsecopsContent
  return (
    <>
