...
import { aiEngineeringContent } from "@/content/services/ai-engineering"

export const metadata: Metadata = {
  title: "AI Engineering",
  description: "Enterprise AI engineering services including MLOps, LLM integration, and intelligent automation.",
}

export default function AIEngineeringPage() {
  const { hero, overview, capabilities, benefits, approach, technologies, cta } = aiEngineeringContent
  return (
    <>
