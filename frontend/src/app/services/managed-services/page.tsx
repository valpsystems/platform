...
import { managedServicesContent } from "@/content/services/managed-services"

export const metadata: Metadata = {
  title: "Managed Services",
  description: "Enterprise managed services including 24/7 monitoring, incident management, and platform operations.",
}

export default function ManagedServicesPage() {
  const { hero, overview, capabilities, benefits, approach, technologies, cta } = managedServicesContent
  return (
    <>
