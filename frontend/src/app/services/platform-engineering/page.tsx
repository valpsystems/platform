...
import { platformEngineeringContent } from "@/content/services/platform-engineering"

export const metadata: Metadata = {
  title: "Platform Engineering",
  description: "Enterprise platform engineering services including internal developer platforms and self-service portals.",
}

export default function PlatformEngineeringPage() {
  const { hero, overview, capabilities, benefits, approach, technologies, cta } = platformEngineeringContent
  return (
    <>
